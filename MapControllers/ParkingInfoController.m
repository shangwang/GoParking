...
#import "RSVPViewController.h"
@interface ParkingInfoController ()

@end

@implementation ParkingInfoController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row==0&&0==indexPath.section){
        ...
        MapinfoCell* cell = [[[NSBundle mainBundle] loadNibNamed:@"MapinfoCell" owner:self options:nil] lastObject];
